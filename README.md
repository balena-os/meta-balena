...
The OS supports overlaying container images stored in the data partition. To disable the overlaying, specify `balena.disable_overlays` as a kernel command line argument.
