...
do_install:append() {
    ...
    install -m 0644 ${S_UNPACK}/nm-tmpfiles.conf ${D}${sysconfdir}/tmpfiles.d/
    ...
    install -m 0755 ${S_UNPACK}/90shared ${D}${libdir}/NetworkManager/dispatcher.d/
    install -m 0755 ${S_UNPACK}/98dhcp_ntp ${D}${libdir}/NetworkManager/dispatcher.d/
    install -m 0755 ${S_UNPACK}/99onoffline_ntp ${D}${libdir}/NetworkManager/dispatcher.d/
    ...
    if ${@bb.utils.contains('DISTRO_FEATURES','systemd','true','false',d)}; then
        ...
        install -m 0644 ${S_UNPACK}/NetworkManager.conf.systemd ${D}${sysconfdir}/systemd/system/NetworkManager.service.d/NetworkManager.conf
    fi
...
do_deploy() {
    ...
    install -m 0600 "${S_UNPACK}/balena-sample.ignore" "${DEPLOYDIR}/system-connections/"
    install -m 0600 "${S_UNPACK}/README.ignore" "${DEPLOYDIR}/system-connections/"
}
