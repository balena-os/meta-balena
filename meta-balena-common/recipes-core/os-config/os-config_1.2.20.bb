...
# SRC_URI += "crate://crates.io/os-config/1.2.20"
SRC_URI += "git://git@github.com/balena-os/os-config.git;protocol=ssh;nobranch=1;branch=jaomaloy/wait-for-extract-ca"
SRCREV = "a04d80a64364a820fd59a503eba2851ef0a66bbb"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+a04d80a643"
...
SRC_URI += " \
    ...
    crate://crates.io/path-absolutize/3.0.14 \
    crate://crates.io/path-dedot/3.0.18 \
    ...
    crate://crates.io/reqwest/0.11.17 \
...
SRCREV_fatrw = "228b66078678317ea28802369719b235cd10d56f"
