...
do_install_append() {
    ...
    install -m 0755 ${WORKDIR}/fsck ${D}/init.d/75-fsck
    install -m 0755 ${WORKDIR}/rootfs ${D}/init.d/90-rootfs
    install -m 0755 ${WORKDIR}/finish ${D}/init.d/99-finish

    install -m 0755 ${WORKDIR}/machineid ${D}/init.d/91-machineid
    install -m 0755 ${WORKDIR}/resindataexpander ${D}/init.d/76-resindataexpander
    install -m 0755 ${WORKDIR}/fsuuidsinit ${D}/init.d/77-fsuuidsinit
...
FILES_initramfs-module-fsck = "/init.d/75-fsck"

SUMMARY_initramfs-module-fsuuidsinit = "Filesystem UUID/serial initialization"
RDEPENDS_initramfs-module-fsuuidsinit = "${PN}-base initramfs-module-prepare initramfs-module-udev e2fsprogs-tune2fs mtools"
FILES_initramfs-module-fsuuidsinit = "/init.d/77-fsuuidsinit"
...
FILES_initramfs-module-resindataexpander = "/init.d/76-resindataexpander"
