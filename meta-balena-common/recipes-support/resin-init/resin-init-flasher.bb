...
RDEPENDS:${PN}:append = "${@oe.utils.conditional('SIGN_API','','',' cryptsetup dosfstools e2fsprogs-mke2fs os-helpers-fs util-linux-mount util-linux-losetup openssl-bin',d)}"
