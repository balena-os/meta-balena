...
VIDEO_CAMERA = "1"
IMAGE_INSTALL_append = "linux-firmware-ralink wireless-tools parted openssl dosfstools e2fsprogs connman connman-client strace btrfs-tools apt docker-arm"
