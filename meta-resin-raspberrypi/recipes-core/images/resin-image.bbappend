...
RESIN_BOOT_PARTITION_FILES_rpi = " \
    ...
    ${KERNEL_IMAGETYPE}${KERNEL_INITRAMFS}-ds1307-rtc-overlay.dtb:overlays/ds1307-rtc-overlay.dtb \
    ...
    ${KERNEL_IMAGETYPE}${KERNEL_INITRAMFS}-pcf8523-rtc-overlay.dtb:overlays/pcf8523-rtc-overlay.dtb \
